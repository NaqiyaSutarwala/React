...
import TextExpander from "./text expander/textExpander";
import CurrencyConvertor from "./currency converter/convertor";
import GeoLocation from "./geolocation custom hook/geolocation";

const root = ReactDOM.createRoot(document.getElementById("root"));
root.render(
  <React.StrictMode>
    {/* <App /> */}
    {/* <TextExpander collapsedNumWords={20} expanded={true}>
